...
const PixelExperienceItem: React.FC<PixelExperienceItemProps> = ({
  experience,
}) => {
  return (
    <div className="mb-4 border-b border-gray-800 pb-2">
      <div className="flex justify-between items-start">
        <div>
          <h3 className="font-pixel text-s text-pixel-cyan mb-1">
            {experience.title}
          </h3>
          <p className="font-mono text-s mb-1">{experience.company}</p>
        </div>
